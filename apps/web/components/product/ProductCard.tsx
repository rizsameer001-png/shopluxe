  ...
  <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-300">
    ...
    <div className="relative aspect-square overflow-hidden bg-gray-50">
      ...
      <div className="absolute top-3 left-3 flex flex-col gap-1.5">
        ...
        {product.stock === 0 && (
          <span className="bg-gray-400 text-white text-xs font-semibold px-2.5 py-1 rounded-full">
            Sold Out
          </span>
        )}
      </div>
      ...
      {/* Actions */}
      <div className="absolute top-3 right-3 z-10 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-all duration-200 translate-x-2 group-hover:translate-x-0">
        <button
        ...
        <Link
          ...
          className="w-9 h-9 bg-white text-gray-600 hover:text-gray-900 rounded-full flex items-center justify-center shadow-md"
        >
      ...
      {/* Add to cart */}
      <div className="absolute bottom-0 left-0 right-0 p-3 z-10 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-200">
        <button
          onClick={handleAddToCart}
          disabled={addingToCart || product.stock === 0}
          className="w-full bg-gray-900 text-white py-2.5 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 hover:bg-gray-700 disabled:opacity-50"
        >
          {addingToCart ? (
